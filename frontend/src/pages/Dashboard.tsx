...
function BadgeItem({ badge }: { badge: Badge }) {
  ...
  return (
    <div className={`badge-item${badge.earned ? ' badge-earned' : ''}`} title={badge.description}>
      <svg className="badge-svg" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle
          cx="30" cy="30" r="28"
          fill={badge.earned ? `url(#${gradId})` : '#d1d5db'}
          stroke={badge.earned ? `hsl(${badge.hue}, 65%, 48%)` : '#b0b7c3'}
          strokeWidth="2.5"
        />
        <circle
          cx="30" cy="30" r="23"
          fill="none"
          stroke={badge.earned ? 'rgba(255,255,255,0.55)' : 'rgba(255,255,255,0.15)'}
          strokeWidth="1.5"
        />
        <text
          x="30" y="37"
          ...
          fontWeight="700"
          fill={badge.earned ? 'white' : '#aab0bb'}
        >
          {badge.symbol}
        </text>
      </svg>
